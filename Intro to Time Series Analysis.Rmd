...
#You can tell here larger autocorrelations approach 1, while more erratic autocorrelations approach -1. In other words, time series A has high autocorrelation, while time series C has low autocorrelation
```
