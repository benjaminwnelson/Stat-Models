...
###Example
Lets look at a Lag 1 Autocorrelation. This is the correlation of the stock today with it's price yesterday
```{r}
cor(dax[-100], dax[-1]) #This is .99, which indicates that if the price yesterday was high, then the price today should be high

```

Lets look at Lag 2 Autocorrelation. This is the correlation of the stock today with it's price two days ago
```{r}
cor(dax[-(99:100)], dax[-(1:2)])
```

You can also look at Autocorrelations at lag 1 and lag 2 with the Autocorrelation Function acf()
```{r}
